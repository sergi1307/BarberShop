...
class _SelectTimeScreenState extends State<SelectTimeScreen> {
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              // Indicadores (Ahora el QUINTO punto está activo)
              Row(
                children: [
  ...
  // Widget para cada sección (Mañana, Tarde, Noche)
      ...
      children: [
        ...
        GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 4, // 4 columnas como en la captura
            crossAxisSpacing: 10,
            mainAxisSpacing: 10,
            childAspectRatio: 2.2, // Proporción estirada para los botones
          ),
